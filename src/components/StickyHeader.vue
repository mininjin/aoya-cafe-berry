    ...
    <div class="flex items-center py-2 px-4 w-full bg-header">
      <div class="flex items-center flex-grow-0 text-left">
        <img
          src="@/assets/logo.svg"
          alt="ロゴ"
          class="h-10 object-contain rounded-xl overflow-hidden"
          @click="go(HOME)"
        />
      </div>
      <div
        class="flex-grow text-left text-sub px-4 text-xl font-header font-bold"
      >
        café Berry
      </div>
    ...
    <div class="flex h-full w-full">
      ...
      >
        ...
        >
          ...
          <p class="font-header underline text-xl mb-4 px-5" @click="go(HOME)">
            ホーム
          </p>
          <p class="font-header underline text-xl mb-4 px-5" @click="go(BENTO)">
            お弁当
          </p>
          <p class="font-header underline text-xl mb-4 px-5" @click="go(LINK)">
            周辺施設
          </p>
          <p class="font-strong text-xl mb-4 mt-3">ご予約はこちら</p>
          <a
            href="tel:0857860515"
            class="inline-flex items-center underline mb-4 px-5"
            ><font-awesome-icon
              icon="phone-flip"
              class="h-5 mr-2"
            />0857-86-0515</a
